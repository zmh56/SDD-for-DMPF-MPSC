...
def read_conf(path_cfg):
    ...
    parser=OptionParser()
    parser.add_option("--cfg", default=path_cfg) # Mandatory
    ...
    options.num_node_features=Config.get('gnn', 'num_node_features')
    options.hidden_channels=Config.get('gnn', 'hidden_channels')
    options.num_pause_input=Config.get('gnn', 'num_pause_input')
    options.num_att_features=Config.get('gnn', 'num_att_features')
    options.num_emotion_features=Config.get('gnn', 'num_emotion_features')
    options.num_enegy_features=Config.get('gnn', 'num_enegy_features')
    options.num_tromer_features=Config.get('gnn', 'num_tromer_features')
